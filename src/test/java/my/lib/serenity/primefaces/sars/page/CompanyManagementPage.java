...
public class CompanyManagementPage extends AbstractPage {
    ...
    public void fill_value_for_input_search_in_company_management_screen(String text) {
        this.getInputSearch().type_and_enter(text);
    }
...
//        this.getTableCompany().display_all_column();
    ...
    public void input_company_detail(CompanyDetailModel companyDetailModel) {
        ...
        workType.select_result_by_text(companyDetailModel.getWorkType());
        ...
        headOffice.select_result_by_text(companyDetailModel.getHeadOffice());
    ...
    public boolean should_save_company_success() {
        String messageText = this.find(By.xpath("//div[@id='growl_container']//div[@class='ui-growl-message']//p")).getText();
        return this.SAVE_SUCCESS_MESSAGE.equalsIgnoreCase(messageText);
    }
