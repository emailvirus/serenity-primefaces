...
public class EmployeeManagementSteps extends ScenarioSteps {
    ...
    public void fillAllDataInEmployeeManagementModel(EmployeeManagementModel employeeManagementModel) throws InterruptedException {
        ...
        if (employeeManagementModel.getAuthority() != null) {
            ...
            this.employeeManagementPage.fillDataRequireInEmployeeManagement(employeeManagementModel.getEmpName(), employeeManagementModel.getHireDate(), employeeManagementModel.getStatus(), employeeManagementModel.getBaseLocation()
                    , employeeManagementModel.getPosition(), employeeManagementModel.getAuthority(), employeeManagementModel.getEmail());
        }
    ...
    public void fillAllDataRequire(String empName, String hireDate, String status, String baseLocation, String position, String authority, String email) throws InterruptedException {
        this.employeeManagementPage.fillDataRequireInEmployeeManagement(empName, hireDate, status, baseLocation, position, authority, email);
    }
