...
public class EmployeeManagementPage extends AbstractPage {
    ...
    public void fillDataRequireInEmployeeManagement(String empName, String hireDate, String status, String baseLocation, String position, String authority, String email) throws InterruptedException {
        ...
        this.find(By.xpath("//*[text()='" + position + "']//parent::td//preceding::td[1]")).click();
        this.find(By.xpath("//*[text()='" + authority + "']//parent::td//preceding::td[1]")).click();
    ...
    public EmployeeManagementModel createPhantomInputValue() {
        ...
        empModelBeforeReset.setAuthority(String.valueOf(this.getValueAuthority()));
        ...
        empModelBeforeReset.setPosition(this.getValuePosition());
    ...
    public boolean compareValueAfterReset(EmployeeManagementModel empModelBeforeReset) {
        return this.getEmpName().getValue().equals(empModelBeforeReset.getEmpName()) &&
                ...
                String.valueOf(this.getValueAuthority()).equals(empModelBeforeReset.getAuthority()) &&
