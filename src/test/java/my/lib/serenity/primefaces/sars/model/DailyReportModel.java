...
public class DailyReportModel {
    ...
    public boolean equals(Object obj) {
        ...
        return StringUtils.equals(this.getCompanyName(), dailyReportModel.getCompanyName()) && StringUtils.equals(this.getContent(), dailyReportModel.getContent()) && StringUtils.equals(this.getBranch(), dailyReportModel.getBranch())
                ...
                && StringUtils.equals(this.getPurpose(), dailyReportModel.getPurpose()) && StringUtils.equals(this.getReminder(), dailyReportModel.getReminder()) && StringUtils.equals(this.getProjectFlag(), dailyReportModel.getProjectFlag()) && StringUtils.equals(this.getOpenFlag(), dailyReportModel.getOpenFlag())
