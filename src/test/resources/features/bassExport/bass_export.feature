...
Feature: Bass export display
  ...
  @LoggedIn
  Scenario Outline: Open bass export and verify
  ...
  @LoggedIn
  Scenario Outline: Open bass export and use download location
    When I open submenu <menuText> of parent menu <parentMenuText>
  ...
  @LoggedIn
  Scenario Outline: Open bass export use save path
    When I open submenu <menuText> of parent menu <parentMenuText>
    And  In Bass export screen, I click button <exportBtn>
    And In Bass export screen, I click button <editBtn>
    And I save path in download location to new variable
  ...
  @LoggedIn
  Scenario Outline: Open bass export and use button Copy download location
    When I open submenu <menuText> of parent menu <parentMenuText>
    And  In Bass export screen, I click button <exportBtn>
  ...
  @LoggedIn
  Scenario Outline: Open bass export and verify link download api
    When I open submenu <menuText> of parent menu <parentMenuText>
    And In Bass export screen, I click button <exportBtn>
