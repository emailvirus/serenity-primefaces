...
#-------------------------------------------------------------------------------
  ...
  @LoggedIn
  Scenario Outline: initialization screen when create new daily report and verify toggle column
...
#-------------------------------------------------------------------------------
  ...
  @LoggedIn
  Scenario Outline: initialization screen when access from search by date screen
    When I open submenu <submenuText> of menu <menuText>
    ...
    Examples:
      | submenuText    | menuText     | buttonText | branchName | employeeInfo | date       | rowIndex | editButtonText |
      | Search By Date | Daily Report | Search     | 福岡県        | 40000005     | 2012/11/28 | 0        | Edit           |
...
#-------------------------------------------------------------------------------
  ...
  Scenario Outline: paging
    ...
    And In Register daily report, I choose date <date> in calendar date
...
#-------------------------------------------------------------------------------
  ...
  @LoggedIn
  Scenario Outline: create new daily report and fill only required fields
    When I open submenu <submenuText> of menu <menuText>
...
#-------------------------------------------------------------------------------
  ...
  @LoggedIn
  Scenario Outline: create new daily report with category is other works
    When I open submenu <submenuText> of menu <menuText>
    And In Register daily report, I choose category '<categoryType>'
    And I add new Daily report with data below
      | content                                               |
...
#-------------------------------------------------------------------------------
  ...
  @LoggedIn
  Scenario Outline: create new daily report and fill all fields
    When I open submenu <submenuText> of menu <menuText>
    And I add new Daily report with data below
      | companyName | content                                            | branch | personInCharge | department | businessType | purpose | reminder | projectFlag | openFlag |
      | 北開工営    | Verify create new daily report and fill all fields | 北海道    | 庭田次長             | atv        | ソフトウェア       | クレーム    | ON       | ON          | ON       |
...
#-------------------------------------------------------------------------------
  ...
  @LoggedIn
  Scenario Outline: update daily report when access from menu
    When I open submenu <submenuText> of menu <menuText>
    ...
    When I update Daily report with data below
      | companyName | content                    | branch | personInCharge | department | businessType | purpose | reminder | reminderFrom | reminderTo | projectFlag | openFlag |
      | CIJ         | Verify update daily report | 北海道    | 庭田次長           | atv        | ソフトウェア       | クレーム    | ON       | 2016/10/19   | 2016/10/20 | ON          | ON       |
    Then The system should show message save daily report successfully
...
#-------------------------------------------------------------------------------
  ...
  @LoggedIn
  Scenario Outline: verify create new company when create daily report
    When I open submenu <submenuText> of menu <menuText>
    ...
    When I fill Daily report screen with data below
      | content                                            | branch |
      | Verify create new company when create daily report | 山形県    |
    And In Register daily report, I click button Add
    Then The system should show message save daily report successfully
...
#-------------------------------------------------------------------------------
  ...
  @LoggedIn
  Scenario Outline: verify delete daily report
    When I open submenu <submenuText> of menu <menuText>
