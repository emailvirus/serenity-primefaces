...
Feature: Accounting
  ...
  @LoggedIn
  Scenario Outline: search customer by code
    When I open submenu <submenuText> of menu <menuText>
  ...
  @LoggedIn
  Scenario Outline: search customer by other conditions
    When I open submenu <submenuText> of menu <menuText>
    ...
    Examples:
      ...
      | Credit Management | Accounting | aaaaa             | EC7B840A53B2A4BE86BCC0AF3272D57D | aaaaa              | コペル株式会社          | 0        |

  @LoggedIn
  Scenario Outline: change page on paging
    When I open submenu <submenuText> of menu <menuText>
